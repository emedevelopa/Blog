...
const chipCategory = document.querySelectorAll(".main__chip")
...
const posts = [
...

    {
...

      {
        ...
        date: "18/03/25",
        img: "/Assets/img6.jpg",
        resume: "La literatura clásica ha marcado el camino para las obras contemporáneas. Desde los griegos hasta el siglo XIX.",
...

      {
        ...
        date: "05/04/25",
        readingTime: "6 min",
        resume: "Los videojuegos han recorrido un largo camino desde los primeros arcades hasta los gráficos hiperrealistas de hoy en día.",
...

      {
        ...
        date: "07/04/25",
        readingTime: "7 min",
        resume: "Los deportes electrónicos han pasado de ser una afición de nicho a una industria millonaria.",

...
const posts = [
  {
      ...
      date:"23/06/24",
      img:"/Assets/img1.jpg",
      resume: "El arte es una de las expresiones más profundas de la humanidad, reflejando emociones, ideas y culturas a lo largo de la historia.",
...

  {
...

    {
      ...
      date: "18/03/25",
      img: "/Assets/img5.jpg",
      resume: "La literatura fantástica transporta a los lectores a mundos imaginarios, donde todo es posible.",
...

    {
      ...
      date: "18/03/25",
      img: "/Assets/img6.jpg",
      resume: "La literatura clásica ha marcado el camino para las obras contemporáneas.",
...

    {
      ...
      date: "18/03/25",
      img: "/Assets/img7.jpg",
      resume: "La meditación se ha convertido en una herramienta popular para reducir el estrés y mejorar el bienestar emocional.",
...

    {
      ...
      date: "18/03/25",
      img: "/Assets/img8.jpg",
      resume: "La alimentación consciente es una práctica que implica prestar atención plena a lo que comemos, cómo lo comemos y cómo nos hace sentir.",
...

    {
      ...
      date: "18/03/25",
      img: "/Assets/img9.jpg",
      resume: "Los árboles son mucho más que simples plantas. Son esenciales para la vida en la Tierra.",
...

    {
      ...
      resume: "El cuidado de la piel es esencial para mantenerla saludable y radiante.",
      content: "La biodiversidad es la variedad de vida que existe en la Tierra, desde los microorganismos más pequeños hasta los grandes mamíferos. Esta diversidad es esencial para el funcionamiento saludable de los ecosistemas, ya que cada especie juega un papel específico en el equilibrio natural. La biodiversidad contribuye a la estabilidad de los ecosistemas, lo que a su vez asegura el suministro de recursos esenciales para la vida humana, como alimentos, agua limpia y medicamentos. Además, los ecosistemas biodiversos son más resilientes a los cambios, como el cambio climático y las catástrofes naturales. Sin embargo, la biodiversidad está en grave peligro debido a la actividad humana. La deforestación, la contaminación, el cambio climático y la sobreexplotación de los recursos naturales están amenazando a muchas especies. Cada vez más animales y plantas están en peligro de extinción, y muchos ecosistemas están colapsando. Es crucial que tomemos medidas para proteger la biodiversidad. Esto incluye la creación de áreas protegidas, la lucha contra la deforestación, la promoción de prácticas agrícolas y pesqueras sostenibles, y la reducción de las emisiones de gases de efecto invernadero. Además, todos podemos contribuir a la protección de la biodiversidad mediante nuestras decisiones diarias, como reducir el consumo de plásticos, apoyar productos ecológicos y educar a las nuevas generaciones sobre la importancia de cuidar nuestro entorno. La biodiversidad no solo es valiosa por su belleza, sino también por su impacto directo en nuestra supervivencia. Sin ella, los ecosistemas se desestabilizarían, y la humanidad perdería los recursos esenciales para su bienestar.",
...

    {
      ...
      date: "18/03/25",
      img: "/Assets/img12.jpg",
      resume: "El maquillaje natural es perfecto para quienes buscan un look fresco y luminoso.",
...

    {
      ...
      subtitle:"Los videojuegos han recorrido un largo camino desde los primeros arcades hasta los gráficos hiperrealistas de hoy en día.",
      img:"/Assets/img2.jpg",
...

    {
      ...
      category: "Gaming",
      title: "E-Sports",
      subtitle:"Los deportes electrónicos han pasado de ser una afición de nicho a una industria millonaria",
      img:"/Assets/img1.jpg",
      author: "Lucía Fernández",
      date: "07/04/25",
      readingTime: "7 min",
      resume: "Los deportes electrónicos han pasado de ser una afición de nicho a una industria millonaria que atrae a millones de espectadores en todo el mundo.",
      content: `Lo que comenzó como competiciones entre amigos en salones recreativos se ha convertido en un fenómeno global con eventos que llenan estadios y ofrecen premios millonarios. 
                Juegos como League of Legends, Counter-Strike y Valorant han elevado el gaming competitivo a un nuevo nivel, con ligas profesionales, equipos patrocinados y jugadores que se han convertido en verdaderas celebridades.
                Las plataformas de streaming como Twitch han impulsado la popularidad de los e-sports, permitiendo que millones de personas sigan las partidas en vivo y generando nuevas oportunidades para los creadores de contenido. 
                Además, las universidades ya ofrecen becas para jugadores de e-sports, consolidando su estatus como una disciplina deportiva legítima.`,
  ...
  
    {
      ...
      subtitle:"La inteligencia artificial está transformando el mercado laboral.",
      img:"/Assets/img16.jpg",
      author: "Daniel Suárez",
      date: "09/04/25",
      readingTime: "6 min",
      resume: "La inteligencia artificial está transformando el mercado laboral. ",
    ...
    },
    {
      ...
      subtitle:"La red 5G transformará industrias enteras.",
      img:"/Assets/img17.jpg",
      author: "Patricia López",
      date: "11/04/25",
      readingTime: "7 min",
      resume: "La red 5G no solo mejorará la velocidad de internet, sino que transformará industrias enteras.",
...
commentBtn.addEventListener("click", async (event) => {
    ...
    userImg.classList.add("user__pic")
    ...
    userDate.textContent = fecha.toLocaleDateString("es-ES")

    userInfo.appendChild(userName)
    userInfo.appendChild(userDate)
    userContainer.appendChild(userImg)
    userContainer.appendChild(userInfo)
    commentCard.appendChild(userContainer)
...
function createPost () {
    ...
    const postSubtitle = document.querySelector(".post__subtitle")
    const postAuthor = document.querySelector(".post__nameAuthor")
    const readTime = document.querySelector(".post__readTime")
    const postDate = document.querySelector(".post__dateNumber")
    const postCategory = document.querySelector(".text__category")
    const postImg = document.querySelector(".post__image")
    const paragraph = document.querySelector(".paragraph")
    const paragraph2 = document.querySelector(".paragraph2")
    const postQuote = document.querySelector(".paragraph__xxl")

    postTitle.textContent = post.title
    postSubtitle.textContent = post.subtitle
    postAuthor.textContent = post.author
    readTime.textContent = post.time
    postDate.textContent = post.date
    postCategory.textContent = post.category
    postImg.src = post.img
    paragraph.textContent = post.content
    paragraph2.textContent = post.content2
    postQuote.textContent = post.textbold
...
function latestPost () {
  ...
  const randomPosts = [...posts];  // Copiar los posts para no alterar el original
    shuffleArray(randomPosts);  // Mezclar los posts aleatoriamente

    // Tomar los primeros 4 posts aleatorios
    const latestPosts = randomPosts.slice(0, 3);

    latestPosts.forEach(post => {
      const cardArticle = document.createElement("article")
        cardArticle.classList.add("card__article")
        cardArticle.setAttribute("aria-labelledby", `card-title-${post.id}`)
        ...
        timeCard.setAttribute("aria-label", `Fecha de publicación: ${post.date}`)
        ...
        categoryCard.setAttribute("aria-label", `Categoría: ${post.category}`)
        ...
        imgCard.setAttribute("alt", `Imagen del post: ${post.title}`)
        ...
        cardTitle.setAttribute("id", `card-title-${post.id}`)
        ...
        cardLink.setAttribute("aria-label", `Leer más sobre el post: ${post.title}`)

...
const posts = [
...

    {
...

      {
        ...
        contentsec: "La hidratación y la protección solar son dos de los pilares más importantes del cuidado de la piel. Asegúrate de usar productos que se adapten a tu tipo de piel y de consultar con un dermatólogo si tienes dudas sobre qué productos utilizar. Cuidar la piel es una inversión en salud y bienestar que puede tener resultados notables con el tiempo."
...

      {
        ...
        contentsec: "El maquillaje natural no solo te hace ver más fresca y radiante, sino que también es ideal para quienes prefieren no gastar mucho tiempo en su rutina de belleza. Con unos pocos productos y técnicas sencillas, puedes lograr un look que te haga sentir segura y lista para cualquier ocasión."
...

      {
        ...
        date: "05/04/25",
        readingTime: "6 min",
        resumen: "Los videojuegos han recorrido un largo camino desde los primeros arcades hasta los gráficos hiperrealistas de hoy en día. Exploramos cómo la tecnología ha transformado la industria.",
...

      {
        ...
        date: "07/04/25",
        readingTime: "7 min",
        resumen: "Los deportes electrónicos han pasado de ser una afición de nicho a una industria millonaria que atrae a millones de espectadores en todo el mundo. Descubre cómo ha cambiado el panorama del gaming competitivo.",
    ...
    
      {
        ...
        date: "09/04/25",
        readingTime: "6 min",
        resumen: "La inteligencia artificial está transformando el mercado laboral. Exploramos cómo esta tecnología cambiará la forma en que trabajamos y qué sectores se verán más afectados.",
      ...
      },
      {
        ...
        date: "11/04/25",
        readingTime: "7 min",
        resumen: "La red 5G no solo mejorará la velocidad de internet, sino que transformará industrias enteras. Descubre cómo esta tecnología está dando forma a la conectividad del futuro.",
